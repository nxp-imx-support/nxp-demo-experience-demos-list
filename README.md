...
Please note: The below list will be removed in the next release. Please see https://github.com/NXP/nxp-demo-experience-assets/releases for this list in the future.
...
This program allows users to dump the raw frame data from a camera onto a connected drive.
...
An OpenCV example of how to use machine learning to recognize faces. An internet connection is required.
